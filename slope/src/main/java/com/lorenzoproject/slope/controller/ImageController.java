...
import com.lorenzoproject.slope.service.image.IImageService;
...
public class ImageController {
    ...
    @PostMapping("upload")
    public ResponseEntity<ApiResponse> saveImages(@RequestParam List<MultipartFile> files, @RequestParam Long skifacilityId) {
        try {
            List<ImageDto> imageDtos = imageService.saveImages(files, skifacilityId);
